  ...
  return (
    ...
    >
      <div className="max-w-[1440px] mx-auto flex flex-col lg:flex-row min-h-[560px]">
        ...
        <aside className="w-full lg:w-80 bg-[#F7E7D7]/30 border-r border-border/10 p-10 flex flex-col justify-between">
          <div>
            <div className="mb-10">
                  ...
                  <li key={cat.id}>
                    <Link
                      ...
                      className={`flex items-center space-x-4 p-3 -mx-3 rounded-sm w-full text-left transition-all ${
                        isActive
                          ? "bg-[#FDF2E7] text-[#BC3F1C]"
                          : "text-foreground/60 hover:text-[#BC3F1C] hover:bg-[#FDF2E7]/50"
                      }`}
          ...
          <div className="pt-8 border-t border-border/10">
            <Link
              to="/categorias"
              onClick={onClose}
              className="flex items-center justify-between text-[11px] font-bold uppercase tracking-widest text-foreground hover:text-[#BC3F1C] transition-all group"
            >
        ...
        <div className="flex-1 grid grid-cols-12 gap-0">
              ...
              <>
                      ...
                      <li key={sub.id}>
                        <Link
                          ...
                          className={`flex items-center justify-between group transition-colors ${
                            i < 3
                              ? "text-base font-bold text-foreground hover:text-[#BC3F1C]"
                              : "text-sm font-medium text-foreground/60 hover:text-[#BC3F1C]"
                          }`}
                        >
                          {sub.name}
                          {i < 3 && (
                ...
                <div className="mt-auto pt-10">
                  <Link
                    ...
                    onClick={onClose}
                    className="inline-flex items-center gap-2 text-[10px] font-bold uppercase tracking-[0.2em] text-[#BC3F1C] border-b border-[#BC3F1C]/30 pb-1 hover:border-[#BC3F1C] transition-all group"
                  >
          ...
          <div className="col-span-12 lg:col-span-8 p-12 flex flex-col bg-[#F7E7D7]/10">
            ...
            <div className="grid grid-cols-2 gap-10">
              {products.map((product) => {
                ...
                return (
                  ...
                  >
                    <div className="aspect-[4/5] mb-6 overflow-hidden relative shadow-sm bg-[#F3E4D3] rounded-sm">
                      {imageUrl ? (
                        <img
                          src={imageUrl}
                          alt={product.name}
                    ...
                    <div className="space-y-4">
                      <div className="space-y-1">
                        <h4 className="font-serif text-2xl leading-tight group-hover:text-[#BC3F1C] transition-colors">
                          {product.name}
                        </h4>
                        ...
                        <div className="flex gap-1.5 items-center">
                          {technique && (
                            <span className="text-[9px] font-bold uppercase tracking-widest text-[#BC3F1C]">
                              {technique}
                            </span>
                          )}
