...
export const FALLBACK_HOME_SECTIONS: CmsSection[] = [
  ...
  empty('fb-home-4', 40, 'home_block', {
    ...
    title: '',
    body: 'Villa Adelaida conecta a compradores con las Escuelas Taller, artesanas y artesanos de todo el país. Cada pieza tiene origen, autor y proceso documentado.',
    ctaLabel: 'Descubrir cómo funciona Villa Adelaida',
