...
const HistoriaDetail = () => {
      ...
      <div className="min-h-screen bg-[#F7E7D7]">
        <div className="max-w-[1400px] mx-auto px-6 py-32 animate-pulse space-y-16">
          <div className="max-w-5xl mx-auto text-center space-y-8">
            <div className="h-4 w-40 bg-[#F3E4D3] mx-auto rounded" />
            <div className="h-20 w-full bg-[#F3E4D3] rounded" />
            <div className="h-6 w-96 bg-[#F3E4D3] mx-auto rounded" />
          </div>
        </div>
      </div>
    );
  ...
  if (!article) {
    return (
      <div className="min-h-screen bg-[#F7E7D7] flex flex-col items-center justify-center gap-6">
        ...
        <Link
          to="/historias"
          className="inline-flex items-center gap-2 text-[10px] font-bold uppercase tracking-widest hover:text-[#BC3F1C] transition-colors"
        >
  ...
  return (
    <>
      <Helmet>
        <title>{article.title} | Historias Villa Adelaida</title>
        {article.excerpt && (
      ...
      <div className="min-h-screen bg-[#F7E7D7] text-[#1a1a1a]">
        ...
        <header className="max-w-[1400px] mx-auto px-6 pt-16 pb-20 md:pt-24 md:pb-28 flex flex-col items-center text-center">
          <div className="space-y-12 max-w-5xl mx-auto">
            <nav className="flex items-center justify-center gap-2 text-[10px] uppercase tracking-widest text-[#1a1a1a]/40 font-medium">
              ...
              <span>/</span>
              <span className="text-[#BC3F1C] truncate max-w-[200px]">
                {article.title}
              </span>
            </nav>

            <div className="space-y-8">
              <span className="inline-block text-[10px] uppercase tracking-[0.4em] text-[#BC3F1C] font-bold">
            ...
            <div className="flex flex-wrap justify-center items-center gap-8 text-[10px] tracking-[0.2em] font-semibold uppercase text-[#1a1a1a]/50 pt-12 border-t border-[#1a1a1a]/10">
              {publishDate && (
                <span>
              ...
              <button
                onClick={handleShare}
                className="flex items-center gap-2 hover:text-[#BC3F1C] transition-colors"
              >
        ...
        {coverImageUrl && (
          <section className="max-w-[1400px] mx-auto px-6 pb-24">
            ...
            <p className="mt-4 text-[10px] tracking-widest text-[#1a1a1a]/40 uppercase text-center">
        ...
        {/* BLOCKQUOTE OPENER */}
        {article.excerpt && (
          <section className="py-24 md:py-32 px-6 flex justify-center bg-white/50 border-y border-[#1a1a1a]/5">
            <div className="max-w-3xl text-center">
              <div className="w-16 h-px bg-[#BC3F1C]/40 mx-auto mb-16" />
              <blockquote className="font-serif italic text-3xl md:text-4xl leading-relaxed text-[#1a1a1a]">
                "{article.excerpt}"
              </blockquote>
              <div className="w-16 h-px bg-[#BC3F1C]/40 mx-auto mt-16" />
            </div>
          </section>
        )}
        ...
        {article.body && (
          <section className="py-24 md:py-32 px-6">
            <div className="max-w-3xl mx-auto prose prose-lg prose-neutral prose-headings:font-serif prose-headings:italic prose-a:text-[#BC3F1C]">
        ...
        {/* AUTHOR */}
        {article.authorName && (
          <section className="py-20 bg-[#1a1a1a] text-[#F7E7D7] px-6">
            ...
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-x-8 gap-y-12">
              {relatedProducts.map((product) => {
                ...
                return (
                  ...
                  >
                    <div className="aspect-square overflow-hidden bg-[#F3E4D3]">
                      {img && (
                        <img
                          src={img}
                          alt={product.name}
                    ...
                    <div className="space-y-1">
                      <h4 className="font-serif text-lg leading-tight group-hover:text-[#BC3F1C] transition-colors line-clamp-2">
                        {product.name}
                      </h4>
                      {price != null && (
        ...
        <section className="py-24 bg-white border-y border-[#1a1a1a]/5">
          <div className="max-w-4xl mx-auto px-6">
            <h4 className="text-[10px] font-bold tracking-[0.4em] text-center text-[#1a1a1a]/30 mb-16 uppercase">
              Profundizar en la huella
            </h4>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
              <Link to="/tiendas" className="group text-center space-y-6">
                <div className="w-16 h-16 mx-auto flex items-center justify-center">
                  <Store className="w-8 h-8 text-[#BC3F1C]" />
                </div>
                <div>
                  <span className="block text-2xl font-serif group-hover:italic transition-all">
                    Conocer el taller
                  </span>
                  <span className="text-[9px] uppercase tracking-[0.3em] text-[#1a1a1a]/40 font-bold">
              ...
              <Link to="/tecnicas" className="group text-center space-y-6">
                <div className="w-16 h-16 mx-auto flex items-center justify-center">
                  <Waypoints className="w-8 h-8 text-[#BC3F1C]" />
                </div>
                <div>
                  <span className="block text-2xl font-serif group-hover:italic transition-all">
                    Explorar técnica
              ...
              <Link to="/territorios" className="group text-center space-y-6">
                <div className="w-16 h-16 mx-auto flex items-center justify-center">
                  <Map className="w-8 h-8 text-[#BC3F1C]" />
                </div>
                <div>
                  <span className="block text-2xl font-serif group-hover:italic transition-all">
                    Ver territorio
        ...
        {/* CLOSING */}
        <section className="py-32 md:py-40 px-6 text-center bg-[#F7E7D7]">
          <div className="max-w-3xl mx-auto space-y-16">
            <blockquote className="text-4xl md:text-5xl font-serif italic text-[#1a1a1a] leading-[1.1]">
              "Cada puntada es un susurro de nuestros ancestros."
            </blockquote>
            <Link
              to="/historias"
              className="inline-block bg-[#1a1a1a] text-white px-12 py-5 uppercase text-[10px] tracking-[0.3em] font-bold hover:bg-[#BC3F1C] transition-all duration-500 shadow-lg"
            >
