    ...
    >
      ...
      <section className="max-w-[1400px] mx-auto px-8 py-20 text-center">
        ...
        <p
          ...
          style={{ color: "#55603c" }}
        >
          Explora la artesanía colombiana a través de sus categorías, técnicas y
          territorios.
        </p>
      </section>
          ...
          <Link to="/categorias" className="group cursor-pointer block">
            ...
            >
              <div>
                ...
                <p
                  className="text-xs mt-1 mb-2 font-light italic"
                  style={{ color: "#55603c" }}
                >
      ...
      <section className="mb-32">
        <div className="max-w-[1400px] mx-auto px-8">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
            {/* Piezas Únicas */}
            <div
              className="flex gap-6 items-center p-6"
            ...
            >
              ...
              <div className="w-2/3">
                ...
                <h2 className="font-serif text-2xl mb-2 italic">
                  Piezas Únicas
                </h2>
                <p
                  className="text-[11px] leading-relaxed mb-4 font-light italic"
                  style={{ color: "#55603c" }}
                >
          ...
          {featuredShops.length > 0
            ...
            : /* Placeholder cards while loading */
              [...Array(4)].map((_, i) => (
                <div key={i}>
                  <div
                    className="aspect-square mb-6 animate-pulse"
                    style={{ backgroundColor: "#e5e1d8" }}
                  />
                  <div
                    className="h-3 w-24 mb-2 rounded animate-pulse"
                    style={{ backgroundColor: "#e5e1d8" }}
                  />
                  <div
