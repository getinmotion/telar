...
const TECHNIQUE_EDITORIAL: Record<string, TechniqueEditorial> = {
  "telar vertical": {
    ...
    craftLabel: "Textil",
    description:
      "El telar vertical es una de las técnicas más antiguas de la humanidad. En Colombia, cada región le imprime su identidad a través de materiales, patrones y rituales.",
    pieces: 124,
    masters: 15,
    mastery: "Alta",
    hours: 210,
  ...
  crochet: {
    ...
    description:
      "Adoptado y transformado por las comunidades Wayúu, da vida a las icónicas mochilas con patrones geométricos únicos.",
    pieces: 210,
    masters: 24,
    mastery: "Alta",
    hours: 210,
  ...
  "cerámica": {
    ...
    craftLabel: "Cerámica",
    description:
      "Del barro negro de La Chamba a la cerámica Ráquira, la arcilla colombiana es un lienzo donde se esculpe la identidad del territorio.",
    pieces: 165,
    masters: 32,
    mastery: "Ancestral",
  },
  "talla en madera": {
    ...
    craftLabel: "Madera",
    description:
      "Transforma troncos en objetos de arte que narran mitos, creencias y la relación de las comunidades con su entorno.",
    pieces: 58,
    masters: 9,
    mastery: "Alta",
  },
  "orfebrería": {
    ...
    craftLabel: "Joyería",
    description:
      "Herencia de los orfebres que entendieron el metal como una extensión del alma. La filigrana momposina es Patrimonio Cultural.",
    pieces: 82,
    masters: 12,
    mastery: "Media",
  },
  ...
  bordado: {
    ...
    craftLabel: "Textil",
    description:
      "Del delicado bordado en tul a las coloridas mantas del Caribe, cada puntada es un registro cultural.",
    pieces: 130,
    masters: 20,
    mastery: "Alta",
  },
  macramé: {
    ...
    craftLabel: "Textil",
    description:
      "Transforma cuerdas en hamacas, redes y piezas decorativas mediante nudos que requieren precisión milimétrica.",
    pieces: 72,
    masters: 14,
    mastery: "Media",
  },
