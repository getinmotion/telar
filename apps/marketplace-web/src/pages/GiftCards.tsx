    ...
    <div className="min-h-screen bg-[#F7E7D7] text-[#1a1a1a]">
      ...
      <header className="relative w-full h-[70vh] min-h-[500px] max-h-[820px] flex items-center justify-center overflow-hidden">
        {(() => {
          ...
          return heroImg ? (
            <>
              ...
              />
              <div className="absolute inset-0 bg-gradient-to-b from-[#1a1a1a]/30 via-[#1a1a1a]/20 to-[#F7E7D7]/90" />
            </>
          ) : (
        ...
        <div className="relative z-10 text-center px-6 max-w-4xl">
          <span className="text-[#BC3F1C] text-xs uppercase tracking-[0.3em] mb-4 block font-bold">
            Curaduria Exclusiva
          </span>
          ...
          {GIFT_INTENTIONS.map((intent, i) => {
            ...
            return (
              <Link
                ...
                className={`group relative aspect-[3/4] bg-[#1a1a1a]/5 overflow-hidden rounded-sm cursor-pointer ${
                  i % 2 === 1 ? "md:mt-12" : ""
                }`}
              >
                {img && (
                ...
                <div className="absolute bottom-8 left-8 z-20">
                  <h3 className="font-serif text-2xl text-[#F7E7D7]">
                    {intent.title}
                  </h3>
                  <p className="text-[#F7E7D7]/80 text-sm uppercase tracking-widest mt-2 font-bold">
                    {intent.subtitle}
                  </p>
                </div>
              </Link>
      ...
      <section className="bg-[#FDF2E7] py-32">
        <div className="max-w-7xl mx-auto px-6 md:px-12">
          <div className="text-center mb-20">
            <h2 className="font-serif text-5xl italic mb-6">
              Selecciones Curadas
            </h2>
            <div className="w-24 h-px bg-[#BC3F1C] mx-auto" />
          </div>
          <div className="grid grid-cols-1 md:grid-cols-12 gap-8">
            {/* Large Feature — La Ruta de la Seda (Cauca · Agroarte) */}
            <div className="md:col-span-7 bg-[#F7E7D7] rounded-sm p-12 flex flex-col justify-between min-h-[500px]">
              <div>
                <span className="text-[#BC3F1C] font-bold text-xs tracking-widest uppercase mb-4 block">
              ...
              <div className="mt-8">
                <div className="w-full h-64 mb-8 rounded-sm overflow-hidden bg-[#1a1a1a]/5">
                  {caucaImage && (
                    <img
                      src={caucaImage}
                ...
                <div className="flex flex-wrap items-center gap-6">
                  <Link
                    ...
                    className="font-bold border-b-2 border-[#BC3F1C] pb-1 hover:text-[#BC3F1C] transition-colors text-sm uppercase tracking-widest"
                  >
                    Ver la pieza{" "}
                  ...
                  <Link
                    to="/territorio/cauca"
                    className="text-[10px] uppercase tracking-widest font-bold text-[#4D4D4D] hover:text-[#BC3F1C] transition-colors"
                  >
            ...
            <div className="md:col-span-5 flex flex-col gap-8">
              <Link
                to="/tecnicas"
                className="bg-[#F7E7D7] p-8 rounded-sm flex items-center gap-6 group cursor-pointer overflow-hidden"
              >
                {(() => {
                  const img = editorialImage(5);
                  return (
                    <div className="w-24 h-24 shrink-0 rounded-sm overflow-hidden bg-[#1a1a1a]/5">
                      {img && (
                        <img
                          src={img}
                ...
                <div>
                  <h4 className="font-serif text-xl mb-1 group-hover:text-[#BC3F1C] transition-colors">
              ...
              <div className="bg-[#1a1a1a] p-8 rounded-sm flex flex-col justify-between flex-grow overflow-hidden">
                {(() => {
                  const img = editorialImage(6);
                  return (
                    <div className="w-full h-40 mb-6 rounded-sm overflow-hidden bg-[#F7E7D7]/5">
                      {img && (
                        <img
                          src={img}
                ...
                <h4 className="font-serif text-2xl text-[#F7E7D7] mb-4">
                  El Arte de Empacar
                </h4>
                <p className="text-[#F7E7D7]/60 text-sm mb-6">
                  Nuestros empaques son piezas de arte por derecho propio,
                  creados en papel de fibra natural.
                </p>
                <span className="text-[#BC3F1C] text-xs tracking-widest font-bold uppercase">
                  Ver mas
                </span>
              </div>
            </div>
      ...
      {recommendations.length > 0 && (
        <section className="py-20 px-6 md:px-12 max-w-7xl mx-auto">
          <div className="flex justify-between items-baseline mb-16">
            <h2 className="font-serif text-4xl">Recomendaciones de Villa Adelaida</h2>
            <Link
              to="/productos"
              className="text-sm uppercase tracking-tight border-b border-[#1a1a1a] font-bold hover:text-[#BC3F1C] hover:border-[#BC3F1C] transition-colors"
            >
            ...
            {recommendations.map((product) => {
              ...
              return (
                <Link
                  ...
                  className="group"
                >
                  <div className="relative aspect-[4/5] bg-[#1a1a1a]/5 overflow-hidden mb-6 rounded-sm">
                    {imageUrl && (
                      <img
                        src={imageUrl}
                        alt={product.name}
                  ...
                  <div className="space-y-1">
                    <p className="text-[10px] text-[#4D4D4D] uppercase tracking-[0.15em]">
                      {dept}
                      {dept && technique && " / "}
                      {technique}
                    </p>
                    <h3 className="font-serif text-lg group-hover:text-[#BC3F1C] transition-colors">
                      {product.name}
                    </h3>
                    <p className="text-[#BC3F1C] font-bold text-sm">
      ...
      {/* <section className="py-32 bg-white border-y border-[#1a1a1a]/5">
        <div className="max-w-7xl mx-auto px-6 md:px-12">
          <div className="text-center mb-20">
            ...
            <p className="text-[#4D4D4D] max-w-lg mx-auto leading-relaxed">
          ...
          <div className="flex flex-wrap justify-center gap-12 mb-16">
            <div className="flex items-center gap-3">
              <ShoppingCart className="w-4 h-4 text-[#BC3F1C]" />
              <span className="text-[9px] font-bold uppercase tracking-widest text-[#1a1a1a]/60">
                Valida en todo el marketplace
              </span>
            </div>
            <div className="flex items-center gap-3">
              <Gift className="w-4 h-4 text-[#BC3F1C]" />
              <span className="text-[9px] font-bold uppercase tracking-widest text-[#1a1a1a]/60">
                Saldo multiples compras
              </span>
            </div>
            <div className="flex items-center gap-3">
              <Mail className="w-4 h-4 text-[#BC3F1C]" />
              <span className="text-[9px] font-bold uppercase tracking-widest text-[#1a1a1a]/60">
                Entrega por correo
              </span>
            </div>
              ...
              return (
                <div
                  ...
                  className={`relative border transition-all duration-300 p-8 ${
                    isSelected
                      ? "border-[#BC3F1C] shadow-lg"
                      : "border-[#1a1a1a]/10 hover:border-[#1a1a1a]/30"
                  }`}
                >
                  <div className="flex items-center justify-between mb-6">
                    <Gift className="w-6 h-6 text-[#BC3F1C]" />
                    ...
                    <div className="space-y-4">
                      <div className="space-y-2">
                        <Label
                          ...
                          className="text-[9px] font-bold uppercase tracking-widest text-[#1a1a1a]/60 flex items-center gap-1"
                        >
                        ...
                        <Input
                          ...
                          className="bg-[#F7E7D7] border-[#1a1a1a]/10 text-sm"
                      ...
                      <div className="flex gap-3 pt-2">
                        <button
                          ...
                          className="flex-1 border border-[#1a1a1a]/20 py-3 text-[10px] font-bold uppercase tracking-widest hover:border-[#1a1a1a] transition-colors"
                        >
                          Cancelar
                        </button>
                        <button
                          onClick={() => handleAddToCart(card)}
                          className="flex-1 bg-[#BC3F1C] text-white py-3 text-[10px] font-bold uppercase tracking-widest hover:bg-[#1a1a1a] transition-colors flex items-center justify-center gap-2"
                        >
                    ...
                    <button
                      ...
                      className={`w-full py-3 text-[10px] font-bold uppercase tracking-widest transition-all flex items-center justify-center gap-2 ${
                        isAdded
                          ...
                          : "bg-[#1a1a1a] text-white hover:bg-[#BC3F1C]"
                      }`}
                    >
                      {isAdded ? (
                        <>
      ...
      {/* Corporate Section */}
      <section className="w-full bg-[#1a1a1a] py-32 overflow-hidden">
        <div className="max-w-7xl mx-auto px-6 md:px-12 grid grid-cols-1 md:grid-cols-2 gap-24 items-center">
          <div className="order-2 md:order-1">
            <div className="w-full aspect-square rounded-sm overflow-hidden bg-[#F7E7D7]/5">
              {(() => {
          ...
          <div className="order-1 md:order-2 space-y-12">
            <div className="space-y-6">
              <span className="text-[#BC3F1C] font-bold text-xs tracking-widest uppercase block">
                Servicios B2B
              </span>
              <h2 className="font-serif text-5xl md:text-6xl text-[#F7E7D7] leading-tight">
                Regalos que cuentan su proposito
              </h2>
              <p className="text-[#F7E7D7]/60 text-lg leading-relaxed">
            ...
            <div className="flex flex-col gap-6">
              <div className="flex items-start gap-4">
                <span className="text-[#BC3F1C] mt-1">✦</span>
                <div>
                  <h4 className="text-[#F7E7D7] font-bold mb-1">
                    Trazabilidad Total
                  </h4>
                  <p className="text-[#F7E7D7]/50 text-sm">
            ...
            <a
              ...
              className="inline-block bg-[#BC3F1C] text-white px-12 py-5 font-bold text-[10px] uppercase tracking-widest hover:bg-white hover:text-[#1a1a1a] transition-all"
            >
          ...
          {[
            {
              ...
              a: "Al completar la compra, el destinatario recibira un codigo unico por correo electronico. Este codigo se puede usar en el checkout de cualquier compra en el Marketplace de Villa Adelaida.",
            },
            {
              q: "La Gift Card tiene fecha de vencimiento?",
              a: "Las Gift Cards de Villa Adelaida no tienen fecha de vencimiento. El saldo permanece disponible hasta que se utilice por completo.",
            },
            {
            ...
            <div key={i} className="border-b border-[#1a1a1a]/5 pb-10">
              <h3 className="font-serif text-xl mb-3">{faq.q}</h3>
              <p className="text-[#4D4D4D] leading-relaxed font-light">
                {faq.a}
              </p>
            </div>
          ))}
