...
const devolutionProcess = [
  {
    ...
    description: "Dentro de los 7 días calendario de recibido el producto, comunícate con el artesano a través de Villa Adelaida para notificar tu intención de devolución."
  },
  {
    step: 2,
