...
const faqs = [
  {
    question: "¿Qué es Villa Adelaida?",
    answer: "Villa Adelaida es el Centro Nacional de Diseño e Innovación, una iniciativa del Ministerio de las Culturas, las Artes y los Saberes en alianza con la Corporación Colombia Crea Talento (CoCrea). Su marketplace conecta los productos elaborados por artesanas, artesanos, Escuelas Taller, diseñadores y emprendimientos culturales de todo el país con personas que valoran el trabajo hecho a mano, la tradición y el diseño con identidad."
  },
  {
    question: "¿Los productos son 100% artesanales?",
    answer: "Sí, todos los productos en Villa Adelaida son elaborados a mano por artesanas, artesanos, Escuelas Taller y unidades productivas colombianas. Verificamos la autenticidad y el origen de cada pieza antes de publicarla en la plataforma."
  },
  {
    question: "¿Cómo sé que mi compra llega al artesano?",
    answer: "Villa Adelaida habilita el comercio directo entre compradores y talleres, sin intermediarios: cada compra fortalece a las unidades productivas, a las Escuelas Taller y a las economías culturales, populares y comunitarias de los territorios."
  },
  {
  ...
  },
  {
    ...
    answer: "Aceptamos tarjetas de crédito, débito, PSE, Nequi y gift cards de Villa Adelaida. Todos los pagos son seguros y procesados a través de plataformas certificadas."
  },
  {
  ...
  },
  {
    ...
    answer: "Sí, puedes comprar gift cards digitales de Villa Adelaida. Son perfectas para regalar y apoyar a los artesanos colombianos."
  }
];
      ...
      <section className="max-w-[1400px] mx-auto px-6 mb-16">
        ...
        <div className="py-8 border-b border-charcoal/5">
          ...
          <p className="text-base md:text-lg text-charcoal/70 max-w-2xl font-sans leading-relaxed">
            Encuentra respuestas a las preguntas más comunes sobre Villa Adelaida
          </p>
        </div>
      </section>
