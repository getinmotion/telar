...
const TECHNIQUE_DATA: Record<string, TechniqueEditorial> = {
  ...
  filigrana: {
    ...
    explanationCards: [
      ...
      {
        title: "Impacto Villa Adelaida",
        text: "Transparencia de origen, inclusión financiera para artesanos sin banca y materias primas sostenibles (plata reciclada, oro libre de mercurio). Comprar filigrana en Villa Adelaida es financiar un linaje.",
      },
    ],
    culturalQuote:
  ...
  return (
    <div className="min-h-screen" style={{ backgroundColor: "#FDF2E7", color: "#1a1a1a" }}>
      ...
      <section className="max-w-[1400px] mx-auto px-6 py-16">
        <nav className="flex text-[10px] uppercase tracking-widest gap-2 font-sans mb-12" style={{ color: "rgba(20,21,15,0.5)" }}>
          <Link to="/" className="hover:text-[#27423F] transition-colors">Inicio</Link>
          <span>/</span>
          <Link to="/tecnicas" className="hover:text-[#27423F] transition-colors">Técnicas</Link>
          <span>/</span>
          <span style={{ color: "#27423F" }} className="font-bold">{displayData.name}</span>
        </nav>
        ...
        <div className="grid lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="lg:col-span-7">
            <div className="aspect-[21/9] rounded-sm relative overflow-hidden border border-foreground/10 group" style={{ backgroundColor: "#FBEFE1" }}>
              {(() => {
                ...
                return imgUrl ? (
                  ...
                  <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
                    <span className="text-6xl font-serif italic" style={{ color: "rgba(20,21,15,0.06)" }}>
                      {displayData.name}
                    </span>
                  </div>
                );
      ...
      <section className="px-6 py-24" style={{ backgroundColor: "#FDF2E7" }}>
        <div className="max-w-[1400px] mx-auto">
          <div className="mb-16 flex justify-between items-baseline">
            <h2 className="text-4xl font-serif italic">Cómo se hace</h2>
            <span className="text-[10px] uppercase tracking-widest font-bold font-sans" style={{ color: "rgba(20,21,15,0.4)" }}>
              El oficio
            </span>
          </div>
      ...
      <section className="px-6 py-32 max-w-[1400px] mx-auto">
        ...
        {displayProducts.length > 0 ? (
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
            {[1, 2, 3, 4].map((i) => (
              <div key={i}>
                <div className="aspect-[3/4] mb-6 rounded-sm border border-foreground/10 animate-pulse" style={{ backgroundColor: "#FBEFE1" }} />
      ...
      {relevantShops.length > 0 && (
        <section className="px-6 py-32" style={{ backgroundColor: "#1a1a1a", color: "#FDF2E7" }}>
          <div className="max-w-[1400px] mx-auto">
            <div className="flex justify-between items-end mb-16">
              <div>
                <h2 className="text-4xl font-serif">Talleres que dominan esta técnica</h2>
                <p className="text-[10px] font-bold uppercase tracking-[0.5em] mt-2 font-sans" style={{ color: "rgba(255,255,255,0.5)" }}>
                  Maestros del oficio
                </p>
              </div>
              <Link
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
              {relevantShops.map((shop) => (
                <Link
                  ...
                  className="group"
                >
                  <div className="aspect-square mb-6 overflow-hidden rounded-sm border border-white/10" style={{ backgroundColor: "rgba(255,255,255,0.05)" }}>
                  ...
                  <span className="text-[#C4D6CF] font-bold uppercase tracking-widest text-[9px] mb-1 block">
                    {shop.department || shop.region || "Colombia"}
                  </span>
                  <h4 className="font-serif text-xl text-white group-hover:text-[#C4D6CF] transition-colors">
                    {shop.shopName}
                  </h4>
                </Link>
              ))}
      ...
      {displayData.territories.length > 0 && (
        <section className="px-6 py-32 max-w-[1400px] mx-auto">
          <div className="mb-12">
            ...
            <p className="text-[10px] uppercase tracking-[0.4em] font-bold font-sans mt-2" style={{ color: "rgba(20,21,15,0.5)" }}>
              Raíces geográficas
            </p>
          </div>
          <div className="flex gap-8 overflow-x-auto pb-4 -mx-6 px-6 scrollbar-hide">
            {displayData.territories.map((tSlug) => (
              ...
              >
                <div className="aspect-[16/10] rounded-sm mb-4 overflow-hidden relative border border-foreground/10" style={{ backgroundColor: "#FBEFE1" }}>
                  <div className="absolute inset-0 bg-black/0 group-hover:bg-black/5 transition-colors duration-500" />
                </div>
                <h3 className="text-xl font-serif italic group-hover:text-[#27423F] transition-colors">
      ...
      <section className="relative px-6 py-40 overflow-hidden bg-white border-y" style={{ borderColor: "rgba(20,21,15,0.05)" }}>
        <div className="max-w-4xl mx-auto text-center space-y-10">
          ...
          <p className="text-xl md:text-2xl leading-relaxed italic font-serif" style={{ color: "rgba(20,21,15,0.8)" }}>
          ...
          {relatedTechniques.map((tSlug) => {
            ...
            return (
              <Link key={tSlug} to={`/tecnica/${tSlug}`} className="group block">
                <div
                  className="aspect-[4/3] rounded-sm border border-foreground/10 mb-6 relative overflow-hidden"
                ...
                >
                  {relImg ? (
                    ...
                    <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
                      <span className="text-4xl font-serif italic" style={{ color: "rgba(20,21,15,0.06)" }}>
                        {t.name}
                      </span>
                    </div>
                  )}
                </div>
                <h3 className="text-2xl font-serif italic group-hover:text-[#27423F] transition-colors">{t.name}</h3>
