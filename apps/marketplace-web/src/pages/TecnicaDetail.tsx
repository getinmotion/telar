    ...
    <div className="min-h-screen" style={{ backgroundColor: "#f5f1e6", color: "#2b2f26" }}>
      ...
      <section className="max-w-[1400px] mx-auto px-6 py-16">
        <nav className="flex text-[10px] uppercase tracking-widest gap-2 font-sans mb-12" style={{ color: "rgba(44,44,44,0.4)" }}>
          <Link to="/" className="hover:text-[#2e5424] transition-colors">Inicio</Link>
          <span>/</span>
          <Link to="/tecnicas" className="hover:text-[#2e5424] transition-colors">Técnicas</Link>
          <span>/</span>
          <span style={{ color: "#2e5424" }} className="font-bold">{displayData.name}</span>
        </nav>
      ...
      {relevantShops.length > 0 && (
        <section className="px-6 py-32" style={{ backgroundColor: "#2b2f26", color: "#f5f1e6" }}>
          <div className="max-w-[1400px] mx-auto">
            <div className="flex justify-between items-end mb-16">
              <div>
          ...
          <div className="flex gap-8 overflow-x-auto pb-4 -mx-6 px-6 scrollbar-hide">
            {displayData.territories.map((tSlug) => (
              ...
              >
                ...
                <h3 className="text-xl font-serif italic group-hover:text-[#2e5424] transition-colors">
          ...
          {relatedTechniques.map((tSlug) => {
            ...
            return (
              <Link key={tSlug} to={`/tecnica/${tSlug}`} className="group block">
                ...
                <h3 className="text-2xl font-serif italic group-hover:text-[#2e5424] transition-colors">{t.name}</h3>
