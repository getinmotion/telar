      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 lg:py-16">
          ...
          <div className="flex flex-col justify-center">
            ...
            <div className="flex flex-wrap gap-3 mb-12">
              ...
              {(product.styles ?? []).map((style) => (
                <span
                  key={style}
                  className="border border-[#2c2c2c]/10 text-[#2c2c2c]/60 px-4 py-1.5 rounded-full text-[10px] uppercase tracking-widest"
                >
        ...
        {product.shortDescription && (
          <section className="max-w-3xl mx-auto text-center mb-24 py-12 border-y border-[#2c2c2c]/5">
            <span className="inline-flex items-center gap-2 text-[#ec6d13] font-bold uppercase text-[10px] tracking-[0.3em] mb-6">
              <Quote className="w-4 h-4" />
              Descripción
            </span>
            <blockquote className="font-serif text-xl lg:text-2xl text-[#2c2c2c] leading-relaxed italic px-8">
              {product.shortDescription}
            </blockquote>
          </section>
        )}
        ...
        {product.history && (
          <section className="grid grid-cols-1 md:grid-cols-2 gap-16 mb-24 items-center bg-white rounded-3xl p-8 lg:p-16 shadow-sm">
            <div>
              <span className="inline-flex items-center gap-2 text-[#ec6d13] font-bold uppercase text-[10px] tracking-[0.3em] mb-4">
        ...
        {/* ═══════════════ PROCESS + DETAILS ═══════════════ */}
        <section className="grid grid-cols-1 md:grid-cols-2 gap-12 mb-8 border-y border-[#2c2c2c]/10 py-16">
          {/* Proceso artesanal */}
          <div className="space-y-6">
            <h5 className="flex items-center gap-2 text-xl font-serif italic text-[#2c2c2c]">
              <Hammer className="w-5 h-5 text-[#ec6d13]" />
              Proceso artesanal
            </h5>
            <ul className="space-y-5 text-sm text-[#2c2c2c]/70">
              ...
              {(product.techniques?.length > 0 || product.craft) && (
                <li className="flex items-start gap-3">
                  <span className="mt-0.5 flex-shrink-0 inline-flex items-center justify-center w-8 h-8 rounded-full bg-[#ec6d13]/10">
                    <Scissors className="w-4 h-4 text-[#ec6d13]" />
                  </span>
                  <span className="flex flex-col gap-1">
                    <span className="text-[10px] uppercase tracking-widest font-bold opacity-40">
                      Técnica
              ...
              {(product.leadTimeDays || product.productionTime) && (
                <li className="flex items-start gap-3">
                  <span className="mt-0.5 flex-shrink-0 inline-flex items-center justify-center w-8 h-8 rounded-full bg-[#ec6d13]/10">
                    <Clock className="w-4 h-4 text-[#ec6d13]" />
                  </span>
                  <span className="flex flex-col gap-1">
                    <span className="text-[10px] uppercase tracking-widest font-bold opacity-40">
          ...
          <div className="space-y-6 bg-white rounded-2xl border border-[#2c2c2c]/10 shadow-sm p-8">
            <h5 className="flex items-center gap-2 text-xl font-serif italic text-[#2c2c2c]">
          ...
          {(product.careNotes || product.usageSuggestions) && (
            <div className="md:col-span-2 grid grid-cols-1 md:grid-cols-2 gap-8 bg-white rounded-2xl border border-[#2c2c2c]/10 shadow-sm p-8">
              {toLines(product.careNotes).length > 0 && (
                <div className="space-y-5">
                  <div>
                    ...
                    <h5 className="flex items-center gap-2 text-xl font-serif italic text-[#2c2c2c] mt-1">
                  ...
                  <ul className="space-y-3 text-sm text-[#2c2c2c]/70">
                    {toLines(product.careNotes).map((line) => (
                      <li key={line} className="flex items-start gap-3">
                        <span className="mt-0.5 flex-shrink-0 inline-flex items-center justify-center w-8 h-8 rounded-full bg-[#ec6d13]/10">
                          <Droplets className="w-4 h-4 text-[#ec6d13]" />
                        </span>
          ...
          {(product.processDescription ||
            ...
            <div className="md:col-span-2 space-y-6 pt-12 border-t border-[#2c2c2c]/10">
        ...
        <p className="text-xs text-[#2c2c2c]/50 italic text-center max-w-2xl mx-auto mb-24">
        ...
        <section className="mb-24 bg-[#2c2c2c] text-white py-8 px-6 rounded-2xl">
              ...
              {shopCoords ? (
                ...
                >
                  <Marker longitude={shopCoords.lng} latitude={shopCoords.lat}>
                    <MapPin className="w-8 h-8 text-[#ec6d13] fill-[#ec6d13]/20" />
                  </Marker>
                </Map>
              ) : (
        ...
        */}
        ...
        {/* ═══════════════ FAIR TRADE BLOCK ═══════════════ */}
        <section className="mb-8 grid grid-cols-1 lg:grid-cols-2 bg-[#2c2c2c] rounded-2xl overflow-hidden shadow-lg">
          ...
          <div className="p-8 lg:p-12 flex flex-col justify-center items-start bg-black">
            ...
            <Link
              to="/newsletter"
              className="inline-block bg-[#ec6d13] text-white px-6 py-3 font-bold text-[11px] uppercase tracking-[0.2em] hover:bg-white hover:text-[#2c2c2c] transition-all"
            >
        ...
        {/* ═══════════════ GIFT BLOCK ═══════════════ */}
        <section className="relative bg-[#1a1a1a] text-white rounded-2xl overflow-hidden mb-24">
          <div className="grid grid-cols-1 lg:grid-cols-2 min-h-[20vh]">
            <div className="p-8 lg:p-12 flex flex-col justify-center items-start z-10">
              ...
              <Link
                to="/giftcards"
                className="bg-[#ec6d13] text-white px-6 py-3 uppercase text-[11px] tracking-[0.2em] font-bold hover:bg-white hover:text-[#2c2c2c] transition-all"
              >
                Explorar regalos
              </Link>
            </div>
