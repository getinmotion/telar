  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-[#F7E7D7] text-[#1a1a1a]">
        ...
        <header className="max-w-[1400px] mx-auto px-6 py-32 flex flex-col items-center text-center">
          <div className="space-y-12 max-w-5xl mx-auto">
            <div className="space-y-8">
              <span className="inline-block text-[10px] uppercase tracking-[0.4em] text-[#1a1a1a]/40 font-bold">
        ...
        {article.description && (
          <section className="py-32 px-6 flex justify-center bg-white/50 border-y border-[#1a1a1a]/5">
        ...
        {isAlcides && artesolProducts.length > 0 && (
          <section className="max-w-[1400px] mx-auto px-6 pb-32">
            <div className="mb-12 text-center">
              <span className="text-[10px] uppercase tracking-[0.4em] text-[#BC3F1C] font-bold">
                Taller Artesol
              </span>
              <h3 className="mt-4 font-serif text-4xl md:text-5xl italic leading-tight">
                Piezas del Taller
              </h3>
              <p className="mt-4 text-[#1a1a1a]/60 italic font-serif max-w-2xl mx-auto">
            ...
            <div className="mt-16 text-center">
              <Link
                ...
                className="inline-block px-12 py-4 border border-[#1a1a1a]/20 text-[10px] font-bold uppercase tracking-[0.3em] hover:bg-[#1a1a1a] hover:text-white transition-all"
              >
        ...
        {/* Author Section */}
        {article.author_name && (
          <section className="py-24 bg-[#1a1a1a] text-[#F7E7D7] px-6">
          ...
          <div className="max-w-4xl mx-auto px-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
              <Link to="/tiendas" className="group text-center space-y-6">
                <div className="w-16 h-16 mx-auto flex items-center justify-center text-[#BC3F1C] text-3xl">
                  ✦
                </div>
                <div>
        ...
        <section className="py-40 px-6 text-center bg-[#F7E7D7]">
