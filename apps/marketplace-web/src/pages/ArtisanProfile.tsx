...
const ArtisanProfile = () => {
  ...
  const chipClass =
    "rounded-full border border-[#2c2c2c]/15 bg-transparent px-4 py-1.5 text-xs font-bold uppercase tracking-[0.15em] text-[#2c2c2c]/70";
    ...
    <div className="bg-[#f9f7f2] text-[#2c2c2c] min-h-screen overflow-x-hidden">
        ...
        <div className="max-w-[1440px] mx-auto px-5 md:px-8 w-full relative z-10">
          <div className="grid grid-cols-12 gap-0">
            <div className="col-span-12 lg:col-span-9">
              ...
              >
                <span className="inline-block bg-[#f9f7f2]/90 backdrop-blur-sm text-[#2c2c2c] leading-[1.05] px-4 py-1 rounded-md">
                  {firstName}
                </span>
                {lastName && (
                  <span className="inline-block bg-[#f9f7f2]/90 backdrop-blur-sm text-[#2c2c2c] leading-[1.05] px-4 py-1 rounded-md">
              ...
              <div className="flex flex-wrap gap-3 md:gap-4">
                <a
                  href="#piezas"
                  className="inline-flex items-center gap-2 bg-[#ec6d13] text-white px-7 md:px-9 py-3 md:py-3.5 text-[11px] font-bold tracking-[0.2em] uppercase hover:bg-[#d55f0a] transition-colors"
                >
                ...
                {currentShop?.shopSlug && (
                  <Link
                    ...
                    className="inline-flex items-center gap-2 bg-[#f9f7f2]/90 backdrop-blur-sm border border-[#2c2c2c]/30 text-[#2c2c2c] px-7 md:px-9 py-3 md:py-3.5 text-[11px] font-bold tracking-[0.2em] uppercase hover:border-[#ec6d13] hover:text-[#ec6d13] transition-colors"
                  >
                    Volver a la tienda
                  </Link>
                )}
          ...
          <div className="grid grid-cols-12 gap-6 md:gap-8 items-end">
            ...
            {heroSubtitle && (
              <div className="col-span-12 lg:col-span-8 flex lg:justify-end">
                <div className="max-w-md lg:text-right bg-[#f9f7f2]/90 backdrop-blur-sm rounded-lg px-5 py-4">
                  <p className="text-base md:text-lg leading-relaxed text-[#2c2c2c]/75 font-light italic">
                    {heroSubtitle}
                  </p>
                </div>
              </div>
            ...
            <div className="grid grid-cols-12 gap-8 md:gap-12 lg:gap-24 items-start">
              ...
              <div className="col-span-12 lg:col-span-6">
                ...
                {(learnedFromLabel || artisanProfile?.learnedFromDetail) && (
                  <div className="mt-10 md:mt-12 border-l-2 border-[#ec6d13]/30 pl-6">
                    <p className="text-[9px] uppercase tracking-[0.3em] text-[#2c2c2c]/40 mb-2">
                      El aprendizaje
                    </p>
                    {learnedFromLabel && (
                      <p className="font-serif italic text-xl md:text-2xl text-[#2c2c2c] mb-3">
                        {learnedFromLabel}
                      </p>
                    )}
                    {artisanProfile?.learnedFromDetail && (
                      <p className="text-base md:text-lg leading-relaxed text-[#2c2c2c]/70 font-light">
                        {artisanProfile.learnedFromDetail}
                      </p>
                    )}
                  </div>
      ...
      <section className="bg-[#1a1a1a] py-24 md:py-36 lg:py-48 relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto px-5 md:px-8 text-center relative z-10">
          ...
          <h3 className="font-serif text-4xl md:text-6xl lg:text-7xl text-[#f9f7f2] mb-4 md:mb-6 italic leading-tight">
            {location ||
              currentShop?.region ||
          ...
          {artisanProfile?.communityVillage && (
            <p className="text-[#f9f7f2]/40 text-[11px] md:text-xs uppercase tracking-[0.3em] font-bold mb-8 md:mb-10">
              {artisanProfile.communityVillage}
            </p>
          )}
          {artisanProfile?.regionalHistory && (
      ...
      {/* ═══ Linea de tiempo ═══ */}
      {timeline.length > 0 && (
        <section className="py-20 md:py-28 lg:py-32 bg-[#f9f7f2]">
          <div className="max-w-[1100px] mx-auto px-5 md:px-8">
            ...
            <ol className="relative border-l border-[#2c2c2c]/15 ml-2 md:ml-4">
              {timeline.map((t, i) => (
                <li
                  key={i}
                  className="mb-10 md:mb-12 last:mb-0 pl-8 md:pl-12 relative"
                >
                  <span className="absolute -left-[7px] top-1.5 w-3 h-3 rounded-full bg-[#ec6d13]" />
                  {t.year && (
                    <p className="font-serif text-2xl md:text-3xl text-[#ec6d13] mb-1">
                      {t.year}
                    </p>
                  )}
                  {t.event && (
                    <p className="text-base md:text-lg leading-relaxed text-[#2c2c2c]/75 font-light max-w-2xl">
                      {t.event}
                    </p>
                  )}
                </li>
        ...
        <section className="py-20 md:py-28 lg:py-32 px-5 md:px-8 bg-white">
          <div className="max-w-[1440px] mx-auto">
            <div className="mb-12 md:mb-16 max-w-3xl">
              ...
              {craftStory && (
                <p className="text-lg md:text-xl leading-[1.6] text-[#2c2c2c]/80 font-light">
                  {craftStory}
                </p>
              )}
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 md:gap-16">
              {techniquesToShow.length > 0 && (
                <div>
                  <p className="text-[9px] uppercase tracking-[0.3em] text-[#2c2c2c]/40 mb-4">
                    Tecnicas
                  </p>
            ...
            {artisanProfile?.uniqueness && (
              <div className="mt-14 md:mt-20 border-t border-[#2c2c2c]/10 pt-10 md:pt-14 max-w-3xl">
                <p className="text-[9px] uppercase tracking-[0.3em] text-[#2c2c2c]/40 mb-3">
                  Lo que lo hace unico
                </p>
                <p className="font-serif italic text-2xl md:text-3xl text-[#2c2c2c] leading-snug">
                  {artisanProfile.uniqueness}
                </p>
              </div>
            )}
      ...
      {hasWorkshop && (
        <section className="py-20 md:py-28 lg:py-32 bg-[#f9f7f2]">
          <div className="max-w-[1440px] mx-auto px-5 md:px-8">
            <div className="flex flex-col md:flex-row md:items-end justify-between mb-12 md:mb-16 border-b border-[#2c2c2c]/5 pb-8 gap-4">
              <h3 className="font-serif text-4xl md:text-5xl lg:text-6xl italic leading-tight">
                El taller
              </h3>
            ...
            {(workshopStory || artisanProfile?.workshopDescription) && (
              <div className="max-w-3xl space-y-6 text-lg md:text-xl leading-[1.6] text-[#2c2c2c]/80 font-light mb-12 md:mb-16">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 md:gap-16">
              {artisanProfile?.creationProcess && (
                <div>
                  ...
                  <p className="text-base md:text-lg leading-relaxed text-[#2c2c2c]/75 font-light">
                    {artisanProfile.creationProcess}
                  </p>
                </div>
              )}
      ...
      {artisanProfile?.motivation && (
        <section className="bg-[#1a1a1a] py-20 md:py-28 lg:py-32 relative overflow-hidden">
          <div className="max-w-3xl mx-auto px-5 md:px-8 text-center relative z-10">
            <p className="text-[#ec6d13] font-bold tracking-[0.5em] uppercase mb-6 md:mb-8 text-[10px]">
              Lo que me mueve
            </p>
            <p className="font-serif text-2xl md:text-3xl lg:text-4xl text-[#f9f7f2] italic leading-snug">
              {artisanProfile.motivation}
            </p>
          </div>
        </section>
                ...
                return (
                  ...
                  >
                    <div className="aspect-[4/5] bg-[#e5e1d8] mb-5 relative overflow-hidden">
                      ...
                      >
                        <Heart
                          className={`w-4 h-4 ${wished ? "fill-[#2e5424]" : ""}`}
                        />
                      </button>
      ...
      {(quote || closingMessage) && (
        <section className="py-20 md:py-28 lg:py-32 bg-[#f9f7f2] border-t border-[#2c2c2c]/5">
          <div className="max-w-3xl mx-auto px-5 md:px-8 text-center">
            {quote && (
              <p className="font-serif italic text-3xl md:text-4xl lg:text-5xl text-[#ec6d13] leading-snug mb-8">
                {/^["“«']/.test(quote.trim()) ? quote : `“${quote}”`}
              </p>
            )}
            {closingMessage && (
              <p className="text-base md:text-xl text-[#2c2c2c]/60 font-light leading-relaxed">
                {closingMessage}
              </p>
            )}
            <p className="mt-8 text-[10px] uppercase tracking-[0.3em] text-[#2c2c2c]/40 font-bold">
              {displayName}
            </p>
          </div>
        </section>
      ...
      {certifications.length > 0 && (
        <section className="py-20 md:py-28 lg:py-32 bg-white border-t border-[#2c2c2c]/5">
