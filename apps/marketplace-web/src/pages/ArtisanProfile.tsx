  ...
  return (
    <div className="bg-[#f5f1e6] text-[#2b2f26] min-h-screen overflow-x-hidden">
        ...
        <div className="max-w-[1440px] mx-auto px-5 md:px-8 w-full relative z-10">
          <div className="grid grid-cols-12 gap-0">
            <div className="col-span-12 lg:col-span-9">
              ...
              <h1
                className="font-serif italic font-bold leading-[0.85] text-[#2b2f26] mb-8 break-words"
                style={{
          ...
          <div className="grid grid-cols-12 gap-6 md:gap-8 items-end">
            ...
            <div className="col-span-12 lg:col-span-8 flex lg:justify-end">
              <div className="max-w-md lg:text-right">
                <p className="text-[10px] tracking-widest uppercase font-bold text-[#2b2f26]/40 mb-2">
                  Perfil del Artesano {editorial.profileNumber}
                </p>
                <p className="text-base md:text-lg leading-relaxed text-[#2b2f26]/60 font-light italic">
          ...
          <div className="grid grid-cols-12 gap-8 md:gap-12 lg:gap-24 items-start">
            ...
            <div className="col-span-12 lg:col-span-6">
              ...
              <div className="space-y-6 md:space-y-8 text-lg md:text-xl leading-[1.6] text-[#2b2f26]/80 font-light">
                  ...
                  editorial.story.map((p, i) => (
                    <p key={i}>
                      {i === 0 && currentShop?.shopName ? (
                        <>
                          El taller de{" "}
                          <span className="font-bold text-[#2b2f26]">
                ...
                <p className="italic font-serif text-2xl md:text-3xl lg:text-4xl text-[#2e5424] py-6 md:py-8 border-y border-[#2e5424]/20 leading-snug">
                  {editorial.quote}
                </p>
              </div>
            </div>
            <div className="col-span-12 lg:col-span-5 pt-4 lg:pt-24">
              <div className="aspect-[4/5] bg-[#e5e1d8] relative max-w-sm mx-auto lg:ml-auto overflow-hidden">
                ...
                <div className="absolute bottom-4 left-4 lg:-bottom-8 lg:-left-8 w-44 h-44 lg:w-56 lg:h-56 bg-[#2b2f26] text-white p-5 lg:p-8 flex items-center justify-center text-center">
      ...
      {(realTechniques.length > 0 || realMaterials.length > 0) && (
        <section className="py-20 md:py-28 lg:py-32 px-5 md:px-8 bg-[#f5f1e6]">
            ...
            <div className="grid grid-cols-12 gap-8 md:gap-12 lg:gap-16">
              {realTechniques.slice(0, 2).map((tech, i) => (
                ...
                >
                  ...
                  <div className="flex items-start justify-between gap-4 border-t border-[#2b2f26]/10 pt-6">
                    <div className="flex-1">
                      <h4 className="font-serif text-2xl md:text-3xl mb-3 md:mb-4">{tech}</h4>
                      {realMaterials.length > 0 && i === 0 && (
                        <p className="text-[#2b2f26]/60 text-sm md:text-base leading-relaxed font-light max-w-sm">
                    ...
                    <ArrowRight className="w-6 h-6 md:w-7 md:h-7 text-[#2e5424] flex-shrink-0 -rotate-45" />
                  </div>
                </div>
              ))}
            </div>
      ...
      <section className="bg-[#20291a] py-24 md:py-36 lg:py-48 relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto px-5 md:px-8 text-center relative z-10">
          ...
          <h3 className="font-serif text-4xl md:text-6xl lg:text-7xl text-[#f5f1e6] mb-8 md:mb-10 italic leading-tight">
            {location || "Colombia"}
          </h3>
      ...
      <section className="py-20 md:py-28 lg:py-32 bg-white">
        <div className="max-w-[1440px] mx-auto px-5 md:px-8">
          <div className="flex flex-col md:flex-row md:items-end justify-between mb-14 md:mb-20 border-b border-[#2b2f26]/5 pb-8 gap-4">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-16 md:gap-20 lg:gap-24">
            {[
              ...
              >
                <span
                  className="font-serif font-bold text-[#2e5424]/5 absolute -top-10 md:-top-16 lg:-top-20 -left-1 md:-left-4 group-hover:text-[#2e5424]/10 transition-colors leading-none select-none"
                ...
                <div className="relative z-10">
                  ...
                  <p className="text-[#2b2f26]/60 text-sm md:text-base leading-relaxed font-light">
                    {step.desc}
                  </p>
                </div>
              </div>
      ...
      <section className="py-20 md:py-28 lg:py-32 bg-[#f5f1e6] border-t border-[#2b2f26]/5">
        <div className="max-w-4xl mx-auto px-5 md:px-8 text-center">
          ...
          <p className="text-base md:text-xl lg:text-2xl text-[#2b2f26]/60 font-light leading-relaxed mb-10 md:mb-12">
