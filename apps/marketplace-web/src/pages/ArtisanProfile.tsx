...
const ArtisanProfile = () => {
  ...
  if (shopLoading && !currentShop) {
    return (
      <div className="bg-[#f5f1e6] min-h-screen flex items-center justify-center px-6">
        <div className="text-center">
          <div className="w-12 h-12 mx-auto mb-6 rounded-full border-2 border-[#2e5424]/20 border-t-[#2e5424] animate-spin" />
          <p className="text-[10px] tracking-[0.3em] uppercase text-[#2b2f26]/40 font-bold">
  ...
  const chipClass =
    "rounded-full border border-[#2b2f26]/15 bg-transparent px-4 py-1.5 text-xs font-bold uppercase tracking-[0.15em] text-[#2b2f26]/70";

  return (
    <div className="bg-[#f5f1e6] text-[#2b2f26] min-h-screen overflow-x-hidden">
      {/* ═══ Hero / Identidad ═══ */}
      <section className="relative lg:min-h-[70vh] flex flex-col justify-end pt-8 md:pt-12 lg:pt-0 pb-12 md:pb-16">
        ...
        <div className="hidden lg:block absolute top-0 right-0 w-2/3 h-full bg-[#e5e1d8] z-0 overflow-hidden">
          {heroImages[0] ? (
            ...
            <div className="w-full h-full flex items-center justify-center text-[#2b2f26]/20 font-serif italic text-xl">
              Retrato del Taller
            </div>
          )}
        </div>
        ...
        <div className="lg:hidden w-full aspect-[4/5] bg-[#e5e1d8] overflow-hidden mb-8">
          {heroImages[0] ? (
            ...
            <div className="w-full h-full flex items-center justify-center text-[#2b2f26]/20 font-serif italic text-base">
              Retrato del Taller
            </div>
          )}
        </div>
        ...
        <div className="max-w-[1440px] mx-auto px-5 md:px-8 w-full relative z-10">
          <div className="grid grid-cols-12 gap-0">
            <div className="col-span-12 lg:col-span-9">
              {heroEyebrow && (
                <p className="text-[#2e5424] font-extrabold tracking-[0.4em] md:tracking-[0.5em] uppercase mb-4 md:mb-6 text-[10px] md:text-[11px]">
                  {heroEyebrow}
                </p>
              )}
              <h1
              ...
              >
                <span className="inline-block bg-[#f5f1e6]/90 backdrop-blur-sm text-[#2b2f26] leading-[1.05] px-4 py-1 rounded-md">
                  {firstName}
                </span>
                {lastName && (
                  <span className="inline-block bg-[#f5f1e6]/90 backdrop-blur-sm text-[#2b2f26] leading-[1.05] px-4 py-1 rounded-md">
              ...
              <div className="flex flex-wrap gap-3 md:gap-4">
                <a
                  href="#piezas"
                  className="inline-flex items-center gap-2 bg-[#2e5424] text-white px-7 md:px-9 py-3 md:py-3.5 text-[11px] font-bold tracking-[0.2em] uppercase hover:bg-[#d55f0a] transition-colors"
                >
                ...
                {currentShop?.shopSlug && (
                  <Link
                    ...
                    className="inline-flex items-center gap-2 bg-[#f5f1e6]/90 backdrop-blur-sm border border-[#2b2f26]/30 text-[#2b2f26] px-7 md:px-9 py-3 md:py-3.5 text-[11px] font-bold tracking-[0.2em] uppercase hover:border-[#2e5424] hover:text-[#2e5424] transition-colors"
                  >
                    Volver a la tienda
                  </Link>
                )}
          ...
          <div className="grid grid-cols-12 gap-6 md:gap-8 items-end">
            <div className="col-span-12 lg:col-span-4 border-l-2 border-[#2e5424] pl-5 md:pl-8 py-1">
              <div className="grid grid-cols-1 gap-4">
                {location && (
                  <div>
                    <p className="text-[9px] uppercase tracking-[0.3em] text-[#2b2f26]/40 mb-1">
                      Ubicacion
                    </p>
            ...
            {heroSubtitle && (
              <div className="col-span-12 lg:col-span-8 flex lg:justify-end">
                <div className="max-w-md lg:text-right bg-[#f5f1e6]/90 backdrop-blur-sm rounded-lg px-5 py-4">
                  <p className="text-base md:text-lg leading-relaxed text-[#2b2f26]/75 font-light italic">
                    {heroSubtitle}
                  </p>
                </div>
              </div>
          ...
          <div className="max-w-[1440px] mx-auto px-5 md:px-8">
            <div className="grid grid-cols-12 gap-8 md:gap-12 lg:gap-24 items-start">
              <div className="hidden lg:block col-span-1">
                <span
                  className="font-serif text-6xl text-[#2e5424]/10 select-none"
              ...
              <div className="col-span-12 lg:col-span-6">
                <p className="lg:hidden text-[#2e5424] font-bold tracking-[0.4em] uppercase mb-4 text-[10px]">
                  Origen
                </p>
                ...
                <div className="space-y-6 md:space-y-8 text-lg md:text-xl leading-[1.6] text-[#2b2f26]/80 font-light">
                ...
                {(learnedFromLabel || artisanProfile?.learnedFromDetail) && (
                  <div className="mt-10 md:mt-12 border-l-2 border-[#2e5424]/30 pl-6">
                    <p className="text-[9px] uppercase tracking-[0.3em] text-[#2b2f26]/40 mb-2">
                      El aprendizaje
                    </p>
                    {learnedFromLabel && (
                      <p className="font-serif italic text-xl md:text-2xl text-[#2b2f26] mb-3">
                        {learnedFromLabel}
                      </p>
                    )}
                    {artisanProfile?.learnedFromDetail && (
                      <p className="text-base md:text-lg leading-relaxed text-[#2b2f26]/70 font-light">
                        {artisanProfile.learnedFromDetail}
                      </p>
                    )}
                  </div>
              ...
              <div className="col-span-12 lg:col-span-5 pt-4 lg:pt-24">
                <div className="aspect-[4/5] bg-[#e5e1d8] relative max-w-sm mx-auto lg:ml-auto overflow-hidden">
                  {(artisanProfile?.workshopPhoto || heroImages[1]) ? (
                    ...
                    <div className="absolute inset-0 flex items-center justify-center text-[#2b2f26]/20 italic text-sm">
                      Vida en el Taller
                    </div>
                  )}
                </div>
      ...
      <section className="bg-[#20291a] py-24 md:py-36 lg:py-48 relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto px-5 md:px-8 text-center relative z-10">
          <p className="text-[#2e5424] font-bold tracking-[0.5em] md:tracking-[0.6em] uppercase mb-6 md:mb-8 text-[10px]">
            Ubicacion del taller
          </p>
          <h3 className="font-serif text-4xl md:text-6xl lg:text-7xl text-[#f5f1e6] mb-4 md:mb-6 italic leading-tight">
            {location ||
              currentShop?.region ||
          ...
          {artisanProfile?.communityVillage && (
            <p className="text-[#f5f1e6]/40 text-[11px] md:text-xs uppercase tracking-[0.3em] font-bold mb-8 md:mb-10">
              {artisanProfile.communityVillage}
            </p>
          )}
            {artisanProfile?.regionalHistory && (
              <p className="text-base md:text-xl text-[#f5f1e6]/50 leading-[1.7] md:leading-[1.8] font-light mb-10 md:mb-12 max-w-2xl mx-auto">
                {artisanProfile.regionalHistory}
              </p>
            )}
            {currentShop?.department && (
              <Link
                ...
                className="group relative inline-block border border-[#2e5424] text-[#2e5424] px-8 md:px-12 py-3 md:py-4 text-[11px] md:text-xs font-bold tracking-[0.25em] md:tracking-[0.3em] uppercase overflow-hidden"
              >
                <span className="relative z-10 group-hover:text-white transition-colors duration-300">
                  Explorar la Region
                </span>
                <div className="absolute inset-0 bg-[#2e5424] translate-y-full group-hover:translate-y-0 transition-transform duration-300" />
              </Link>
            )}
          </div>
        </section>
      ...
      {/* ═══ Linea de tiempo ═══ */}
      {timeline.length > 0 && (
        <section className="py-20 md:py-28 lg:py-32 bg-[#f5f1e6]">
          <div className="max-w-[1100px] mx-auto px-5 md:px-8">
            <div className="mb-12 md:mb-16">
              <p className="text-[#2e5424] font-bold tracking-[0.4em] uppercase mb-4 text-[10px]">
                Trayectoria
              </p>
            ...
            <ol className="relative border-l border-[#2b2f26]/15 ml-2 md:ml-4">
              {timeline.map((t, i) => (
                <li key={i} className="mb-10 md:mb-12 last:mb-0 pl-8 md:pl-12 relative">
                  <span className="absolute -left-[7px] top-1.5 w-3 h-3 rounded-full bg-[#2e5424]" />
                  {t.year && (
                    <p className="font-serif text-2xl md:text-3xl text-[#2e5424] mb-1">
                      {t.year}
                    </p>
                  )}
                  {t.event && (
                    <p className="text-base md:text-lg leading-relaxed text-[#2b2f26]/75 font-light max-w-2xl">
                      {t.event}
                    </p>
                  )}
                </li>
        ...
        <section className="py-20 md:py-28 lg:py-32 px-5 md:px-8 bg-white">
          <div className="max-w-[1440px] mx-auto">
            <div className="mb-12 md:mb-16 max-w-3xl">
              ...
              {craftStory && (
                <p className="text-lg md:text-xl leading-[1.6] text-[#2b2f26]/80 font-light">
                  {craftStory}
                </p>
              )}
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 md:gap-16">
              {techniquesToShow.length > 0 && (
                <div>
                  <p className="text-[9px] uppercase tracking-[0.3em] text-[#2b2f26]/40 mb-4">
                    Tecnicas
                  </p>
            ...
            {artisanProfile?.uniqueness && (
              <div className="mt-14 md:mt-20 border-t border-[#2b2f26]/10 pt-10 md:pt-14 max-w-3xl">
                <p className="text-[9px] uppercase tracking-[0.3em] text-[#2b2f26]/40 mb-3">
                  Lo que lo hace unico
                </p>
                <p className="font-serif italic text-2xl md:text-3xl text-[#2b2f26] leading-snug">
                  {artisanProfile.uniqueness}
                </p>
              </div>
            )}
      ...
      {hasWorkshop && (
        <section className="py-20 md:py-28 lg:py-32 bg-[#f5f1e6]">
          <div className="max-w-[1440px] mx-auto px-5 md:px-8">
            <div className="flex flex-col md:flex-row md:items-end justify-between mb-12 md:mb-16 border-b border-[#2b2f26]/5 pb-8 gap-4">
              <h3 className="font-serif text-4xl md:text-5xl lg:text-6xl italic leading-tight">
                El taller
              </h3>
              <p className="text-[#2b2f26]/40 text-[10px] tracking-widest uppercase mb-1">
                Donde nace cada pieza
              </p>
            </div>

            {(workshopStory || artisanProfile?.workshopDescription) && (
              <div className="max-w-3xl space-y-6 text-lg md:text-xl leading-[1.6] text-[#2b2f26]/80 font-light mb-12 md:mb-16">
            ...
            {workshopGallery.length > 0 && (
              <div className="grid grid-cols-2 md:grid-cols-3 gap-4 md:gap-6 mb-12 md:mb-16">
                {workshopGallery.slice(0, 6).map((img, i) => (
                  <div
                    key={img}
                    className={`bg-[#e5e1d8] overflow-hidden ${
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 md:gap-16">
              {artisanProfile?.creationProcess && (
                <div>
                  ...
                  <p className="text-base md:text-lg leading-relaxed text-[#2b2f26]/75 font-light">
                    {artisanProfile.creationProcess}
                  </p>
                </div>
              )}
      ...
      {artisanProfile?.motivation && (
        <section className="bg-[#20291a] py-20 md:py-28 lg:py-32 relative overflow-hidden">
          <div className="max-w-3xl mx-auto px-5 md:px-8 text-center relative z-10">
            <p className="text-[#2e5424] font-bold tracking-[0.5em] uppercase mb-6 md:mb-8 text-[10px]">
              Lo que me mueve
            </p>
            <p className="font-serif text-2xl md:text-3xl lg:text-4xl text-[#f5f1e6] italic leading-snug">
              {artisanProfile.motivation}
            </p>
          </div>
        </section>
      ...
      <section id="piezas" className="scroll-mt-24 py-20 md:py-28 lg:py-32 px-5 md:px-8 bg-white">
        <div className="max-w-[1440px] mx-auto">
          <div className="flex flex-col md:flex-row md:items-end justify-between mb-12 md:mb-16 gap-6">
            <div>
              <p className="text-[#2e5424] font-bold uppercase tracking-[0.35em] md:tracking-[0.4em] text-[10px] mb-3">
                Catalogo Editorial
              </p>
              <h3 className="font-serif text-4xl md:text-5xl lg:text-6xl italic leading-tight">
            ...
            {currentShop?.shopSlug && (
              <Link
                to={`/tienda/${currentShop.shopSlug}`}
                className="group inline-flex items-center gap-3 text-[11px] md:text-xs font-bold tracking-widest uppercase pb-1 hover:text-[#2e5424] transition-colors self-start md:self-end"
              >
          ...
          {productsLoading ? (
                ...
                return (
                  <Link key={product.id} to={`/product/${product.id}`} className="group">
                    <div className="aspect-[4/5] bg-[#e5e1d8] mb-5 relative overflow-hidden">
                      ...
                      {stock === 0 && (
                        <div className="absolute top-3 left-0 bg-[#2b2f26] text-white text-[8px] font-bold uppercase tracking-[0.2em] px-3 py-1.5">
                          Agotado
                        </div>
                      )}
                      <button
                        ...
                        className={`absolute top-3 right-3 w-9 h-9 bg-white/90 backdrop-blur rounded-full flex items-center justify-center transition-all ${
                          wished
                            ? "opacity-100 scale-100 text-[#2e5424]"
                            : "opacity-0 scale-90 group-hover:opacity-100 group-hover:scale-100 text-[#2b2f26] hover:text-[#2e5424]"
                        }`}
                        onClick={(e) => {
                          e.preventDefault();
                          e.stopPropagation();
                      ...
                      >
                        <Heart className={`w-4 h-4 ${wished ? "fill-[#2e5424]" : ""}`} />
                      </button>
                      <div className="absolute inset-0 bg-[#2e5424]/5 opacity-0 group-hover:opacity-100 transition-opacity pointer-events-none" />
                    </div>
                    <div className="space-y-1">
                      <p className="text-[9px] text-[#2b2f26]/40 uppercase tracking-widest font-bold">
                        {technique ? `${technique} • ` : ""}
                        {location || displayName}
                      </p>
                      <h4 className="font-bold text-sm md:text-base leading-snug group-hover:text-[#2e5424] transition-colors line-clamp-2">
                        {product.name}
                      </h4>
                      <p className="text-[#2e5424] font-black tracking-tight text-sm pt-1">
            ...
            <div className="text-center py-20">
              <p className="text-[#2b2f26]/40 text-sm">
      ...
      {(quote || closingMessage) && (
        <section className="py-20 md:py-28 lg:py-32 bg-[#f5f1e6] border-t border-[#2b2f26]/5">
          <div className="max-w-3xl mx-auto px-5 md:px-8 text-center">
            {quote && (
              <p className="font-serif italic text-3xl md:text-4xl lg:text-5xl text-[#2e5424] leading-snug mb-8">
                {/^["“«']/.test(quote.trim()) ? quote : `“${quote}”`}
              </p>
            )}
            {closingMessage && (
              <p className="text-base md:text-xl text-[#2b2f26]/60 font-light leading-relaxed">
                {closingMessage}
              </p>
            )}
            <p className="mt-8 text-[10px] uppercase tracking-[0.3em] text-[#2b2f26]/40 font-bold">
              {displayName}
            </p>
          </div>
        </section>
      ...
      {certifications.length > 0 && (
        <section className="py-20 md:py-28 lg:py-32 bg-white border-t border-[#2b2f26]/5">
          <div className="max-w-4xl mx-auto px-5 md:px-8 text-center">
            <div className="inline-flex items-center justify-center w-14 h-14 md:w-16 md:h-16 rounded-full bg-[#2e5424]/10 text-[#2e5424] mb-8 md:mb-10">
            ...
            <div className="flex flex-wrap justify-center gap-4 md:gap-8 lg:gap-12 text-[9px] font-bold uppercase tracking-[0.25em] md:tracking-[0.3em] text-[#2b2f26]/40">
              {certifications.map((cert) => (
                <span key={cert} className="flex items-center gap-2">
                  <span className="w-1.5 h-1.5 rounded-full bg-[#2e5424]" />
                  {cert}
                </span>
              ))}
            </div>
