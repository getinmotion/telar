...
@Entity({ name: 'artisan_media_family', schema: 'artesanos' })
export class ArtisanMediaFamily extends BaseEntity {
  @ApiProperty({ description: 'ID único del medio familiar' })
