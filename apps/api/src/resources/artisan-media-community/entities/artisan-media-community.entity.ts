...
@Entity({ name: 'artisan_media_community', schema: 'artesanos' })
export class ArtisanMediaCommunity extends BaseEntity {
  @ApiProperty({ description: 'ID único del medio de comunidad' })
