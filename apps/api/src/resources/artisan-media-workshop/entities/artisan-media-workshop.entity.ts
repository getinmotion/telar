...
@Entity({ name: 'artisan_media_workshop', schema: 'artesanos' })
export class ArtisanMediaWorkshop extends BaseEntity {
  @ApiProperty({ description: 'ID único del medio de taller' })
