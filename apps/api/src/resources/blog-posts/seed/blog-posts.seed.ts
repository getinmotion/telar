...
export interface BlogPostSeedEntry {
  title: string;
  slug: string;
  excerpt: string;
  body: string;
...
export const blogPostsSeed: BlogPostSeedEntry[] = [
  {
