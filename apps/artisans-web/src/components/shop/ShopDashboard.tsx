...
export const ShopDashboard: React.FC = () => {
  ...
  const { refineContent, isRefining: isDescriptionRefining } =
    useAIRefinement();
  ...
  const handleSaveDescription = async () => {
    ...
    try {
      ...
      const refinedDescription = await refineContent({
        ...
        userPrompt:
          "Corrige errores ortográficos y mejora la claridad manteniendo la esencia",
      });
    ...
    try {
      ...
      if (refinedName && refinedName !== editedName.trim()) {
        ...
        toast({
          ...
          description:
            "La IA ha mejorado tu nombre. Guarda para aplicar los cambios.",
        });
      } else {
        toast({
          title: "Sin cambios",
  ...
  useEffect(() => {
    if (initialCheckComplete && !shopLoading && !shop) {
      console.log(
        "[ShopDashboard] Verified no shop exists, redirecting to creation flow",
      );
  ...
  useEffect(() => {
    if (shopLoading && initialCheckComplete) {
      const timeoutId = setTimeout(() => {
        console.warn(
          "[ShopDashboard] Loading timeout reached (15s) after initialCheckComplete",
        );
          ...
          {loadingTimeout ? (
            <Card className="p-8 text-center">
              ...
              <p className="text-xs text-muted-foreground mb-6">
                Intenta reintentar primero. Si el problema persiste, recarga la
                página.
              </p>
              ...
              <div className="flex flex-col gap-3">
                ...
                >
                  <div className="flex items-center gap-3">
                    ...
                    >
                      {products.filter((p) => (p.inventory ?? 0) <= 5).length}{" "}
                      bajo
                    </Badge>
                ...
                >
                  <div className="flex items-center gap-3">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <p className="text-xs text-muted-foreground truncate">
                        Portada de tu tienda
                      </p>
                    </div>
                    <Badge
                      variant={
                        shop.heroConfig?.slides?.length > 0
                          ? "default"
                          : "destructive"
                      }
                      className="text-xs flex-shrink-0"
                ...
                >
                  <div className="flex items-center gap-3">
                    ...
                    <Badge
                      variant={
                        shop.artisanProfileCompleted ? "default" : "destructive"
                      }
                      className="text-xs flex-shrink-0"
                    >
                ...
                >
                  <div className="flex items-center gap-3">
                    ...
                    <Badge
                      variant={
                        shop.contactConfig?.welcomeMessage
                          ? "default"
                          : "destructive"
                      }
                      className="text-xs flex-shrink-0"
                        ...
                        >
                          ...
                          <div className="flex items-center gap-1 flex-shrink-0 ml-auto self-center">
                            <Button
                              ...
                              onClick={() =>
<<<<<<< HEAD
                                navigate(`/productos/subir?edit=true&productId=${product.id}`)
=======
                                navigate(`/productos/editar/${product.id}`)
>>>>>>> 05a6f1ce6436d42c785b87287f400eab43788cee
                              }
                              title="Editar"
                            >
                              <Edit3 className="w-4 h-4" />
