...
> = {
  ...
  changes_requested: {
    ...
    variant: "outline",
    className:
      "text-warning border-warning/50 bg-warning/10 cursor-pointer hover:bg-warning/20",
    showModal: true,
  },
  rejected: {
    label: "Rechazado",
    ...
    variant: "outline",
    className:
      "text-destructive border-destructive/50 bg-destructive/10 cursor-pointer hover:bg-destructive/20",
    showModal: true,
  },
  archived: {
    label: "Archivado",
...
export const ModerationFeedbackBadge: React.FC<
  ModerationFeedbackBadgeProps
> = ({ status, comment, productId, productName }) => {
                ...
                {isRejected ? (
                  <>
                    <li className="list-disc">
                      Revisa el motivo del rechazo arriba
                    </li>
                    <li className="list-disc">
                      Edita tu producto corrigiendo los problemas indicados
                    </li>
                    <li className="list-disc">
                      Asegúrate de que las fotos sean claras y de buena calidad
                    </li>
                    <li className="list-disc">
                      Verifica que la descripción sea precisa y completa
                    </li>
                    <li className="list-disc">
                      Al guardar, se enviará automáticamente a revisión
                    </li>
                  </>
                ) : (
                  <>
                    <li className="list-disc">
                      Revisa los cambios solicitados arriba
                    </li>
                    <li className="list-disc">
                      Edita tu producto haciendo las correcciones
                    </li>
                    <li className="list-disc">
                      Al guardar, se enviará automáticamente a revisión
                    </li>
