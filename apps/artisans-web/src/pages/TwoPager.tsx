...
import { twoPagerTranslations } from './twoPager/twoPagerTranslations';
import { Section } from '../pages/onePager/Section';
import { TwoPagerLayout } from './twoPager/TwoPagerLayout';
...
const TwoPager = () => {
  ...
  const t = twoPagerTranslations[selectedLanguage];
