...
import { ContactWizard } from '@/components/shop/wizards/ContactWizard';
import { useArtisanShop } from '@/hooks/useArtisanShop';
import { Navigate } from 'react-router-dom';

const ContactWizardPage: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-background py-8 px-4">
      ...
      <div className="max-w-5xl mx-auto">
        ...
        <ContactWizard
          shopId={shop.id}
          existingConfig={(shop as any).contact_config}
          onComplete={() => {
            navigate(`/tienda/${shop.shop_slug}/contacto`);
          }}
        />
      </div>
    </div>
...
export default ContactWizardPage;
