...
export const Register = () => {
  ...
  return (
    <div className="min-h-screen bg-background">
      <header className="absolute top-0 left-0 right-0 z-20 pt-4 lg:p-6">
            ...
            <CardContent>
              <Form {...form}>
                <form
                  ...
                  className="space-y-6 text-left [&_input::placeholder]:opacity-70"
                >
                  {/* Nombre y Apellido */}
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <FormField
                      ...
                      rules={{
                        ...
                        validate: (value) =>
                          value.trim() !== "" || "Por favor escribe tu nombre",
                      }}
                      render={({ field }) => (
                        <FormItem>
                          <FormLabel>
                  ...
                  <div className="space-y-3 p-4 bg-muted rounded-lg">
                    ...
                    {hasRUT ? (
                      <FormField
                        ...
                        rules={{
                          required: hasRUT
                            ? "Por favor escribe tu número de RUT"
                            : false,
                        }}
                        render={({ field }) => (
                          <FormItem>
                      ...
                      <p className="text-xs text-muted-foreground">
                        No te preocupes, te ayudaremos a tramitarlo desde tu
                        panel
                      </p>
                    )}
                  </div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <FormField
                      ...
                      name="department"
                      rules={{
                        required: "Por favor selecciona tu departamento",
                      }}
                      render={({ field }) => (
                        <FormItem>
                      ...
                      render={({ field }) => (
                        <FormItem>
                          ...
                          <Select
                            ...
                            value={field.value}
                            disabled={
                              !department || availableCities.length === 0
                            }
                          >
                            <FormControl>
                              <SelectTrigger>
                    ...
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem className="flex flex-row items-start space-x-3 space-y-0">
                          ...
                          <div className="space-y-1 leading-none">
                            <FormLabel className="text-sm leading-tight cursor-pointer">
                              Quiero recibir novedades y consejos para artesanos
                              (opcional)
                            </FormLabel>
                          </div>
                        </FormItem>
