-- Fix reset_user_maturity_progress to use correct column names
-- user_master_context uses 'last_updated' NOT 'updated_at'
...
BEGIN
  ...
  -- Clear master_coordinator_context (uses updated_at)
  ...
  -- Reset user_master_context (uses last_updated NOT updated_at)
...
-- Also fix the trigger to use correct column name
