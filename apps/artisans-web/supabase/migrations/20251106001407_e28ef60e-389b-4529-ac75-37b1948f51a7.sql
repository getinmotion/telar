-- Fix reset_user_maturity_progress function - use correct column names
...
BEGIN
  ...
  -- Clear master_coordinator_context (use updated_at, not last_updated)
  ...
  -- Reset user_master_context (UPDATE to preserve row, use updated_at not last_updated)
